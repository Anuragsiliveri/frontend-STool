...
export function UrlFetchBar({ onFetch, isLoading }: UrlFetchBarProps) {
    ...
    <form onSubmit={handleSubmit} className="flex items-center gap-3">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="h-12 w-full rounded-[var(--radius)] border border-input bg-card pl-11 pr-4 font-mono text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
          required
        />
      </div>
      <button
